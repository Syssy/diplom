...
Wenn die Simulation für alle Teilchen zu Ende geführt wurde, ist die Rückgabe die Liste der Ankunftszeiten aller Teilchen. Ansonsten gilt die Simulation als gescheitert, die Parameter $p_s$ und $p_m$ sorgen offenbar nicht für einen vollständigen Peak innerhalb des simulierten Zeitraumes.
...
\begin{scope}[start chain =1 going right, node distance =0.0mm]
	\node [on chain =1, feld, draw=none] {Phasen $s$};
...
\begin{scope}[start chain =1 going right, node distance =0.0mm,shift={(0cm, -1cm)}]
	\node [on chain =1, feld, draw=none] {Orte $o$};
...
\begin{scope}[start chain =1 going right, node distance =0.0mm,shift={(0cm, -3.5cm)}]
	\node [on chain =1, feld, draw=none] {ps};
...
\begin{scope}[start chain =1 going right, node distance =0.0mm,shift={(0cm, -4.5cm)}]
	\node [on chain =1, feld, draw=none] {pm};
...
\end{tikzpicture}
\caption{Prinzip der schrittweisen Simulation mit den Parametern $p_s=0,8$, $p_m=0,5$}
\label{2p_by_step}
\end{figure}

In Abbildung \ref{2p_by_step} ist eine schematische Darstellung eines Simulationsschritts zu finden. Die angenommenen Wahrscheinlichkeiten für sind hier $p_s = 0,8$ und $p_m = 0,5$
Um eine parallele Bearbeitung aller Teilchen zu ermöglichen, soll nicht jeweils eine explizite Zustandsabfrage gemacht werden. Statt dessen werden für alle $n$ gezogenen Zufallszahlen die daraus resultierenden Übergänge für beide Zustände berechnet. Beispielsweise wurde für die violett und orange markierten Teilchen eine $0,7$ gezogen, was für mobile Teilchen wie das Violette bedeutet, dass sie den Zustand wechseln müssen, für stationäre Teilchen wie das Orangene jedoch, dass sie stationär bleiben. Dadurch, dass alle Übergänge vorberechnet wurden, werden die neuen Zustände über die Formel: $(s_p \land pm_p) \lor (\lnot s_p \land \lnot ps_p)$ berechnet. Für die neuen Orte kann einfach der neue Zustandsvektor auf den alten Ortsvektor addiert werden.
...
\begin{tabular}{ l || l | l | l | l | l | l | l | l | l }
  \hline
  Start & 0 & 1 & 0 & 2 & 2 & 1 & 0 & 2 & 1 \\ \hline 
  ZV & 0,3 & 0,9 & 0,7 & 0,8 & 0,2 & 0,1 & 0,9 & 0,1 & 0,3 \\ \hline
  Maske0 & 1 & 0 & 1 & 0 & 0 & 0 & 1 & 0 & 0 \\ 
  Maske1 & 0 & 1 & 0 & 0 & 0 & 1 & 0 & 0 & 1 \\
  Maske2 & 0 & 0 & 0 & 1 & 1 & 0 & 0 & 1 & 0 \\ \hline
  Ü00 & 0 & 1 & 1 & 1 & 0 & 0 & 1 & 0 & 0 \\ 
  Ü01 & 0 & 1 & 0 & 0 & 0 & 0 & 1 & 0 & 0 \\ \hline
  M0*Ü0 & 0 & 0 & 1 & 0 & 0 & 0 & 2 & 0 & 0 \\ \hline
  Ü10 & 1 & 1 & 1 & 1 & 0 & 0 & 1 & 0 & 1 \\ 
  Ü11 & 0 & 1 & 1 & 1 & 0 & 0 & 1 & 0 & 0 \\ \hline
  M1*Ü1 & 0 & 2 & 0 & 0 & 0 & 0 & 0 & 0 & 1 \\ \hline
  Ü20 & 1 & 1 & 1 & 1 & 1 & 0 & 1 & 0 & 1 \\ 
  Ü21 & 0 & 1 & 1 & 1 & 0 & 0 & 1 & 0 & 0 \\ \hline
  M2*Ü2 & 0 & 0 & 0 & 2 & 1 & 0 & 0 & 0 & 0 \\ \hline
  Resultat & 0 & 2 & 1 & 2 & 1 & 0 & 2 & 0 & 1 \\ \hline
  \hline
\end{tabular}
  
\todo{Erweiterung auf mehr Zustände mit exakt diesem Vorgehen wohl kaum sinnvoll, da zu zeitaufwändig -> Diskussionskapitel?}
