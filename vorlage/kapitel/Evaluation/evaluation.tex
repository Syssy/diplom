...
\todo{Bilder zu verschiedenen Peaks, darunter sehr flache Hügel wie auch extremes Tailing!}
...
Ist $p_{aa}$ jedoch zu klein und $p_{ll}$ zu groß entstehen Peaks, die einen extrem großen Interquartilskoeffizienten haben. %Allerdings ist der Tail so flach, dass er in einem Gesamtchromatogramm wohl eher im Rauschen untergehen würde.
...
% \begin{figure}[h]
% \centering
% \includegraphics[width=0.75\textwidth]{bilder/2s_zeitbreiten}
