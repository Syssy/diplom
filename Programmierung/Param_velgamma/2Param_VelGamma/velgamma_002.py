...
# In dieser Version sind velmin, velmax und ps feste Params, habe aber mit verschiedenen Werten dafür experimentiert
...
# Die W'keit von stationär zu mobil zu wechseln ist ps und hier als fester Parameter gesetzt. 
...
def main():
    ...
    pkombis = [ (0.005, 200), (0.003, 100), (0.0005, 100000), (0.00017, 500000), (0.001, 500000)] #save
   
   # pkombis = [(0.009, 100), (0.005, 100), (0.005, 100), (0.017, 500000), (0.005, 500000)] 
...
#	zufallskombis.append(pkombis[zz])
    ...
    for gamma, vd  in pkombis: 
		...
		try:
		    ...
		    filename = 'v002/l'+str(length)+"/n"+str(number)+'/v'+str(velmin) +'v'+str(velmax)+"p"+str(ps)+ '/Sim_'+ str(round(vd,8)) +'_' +  str(round(gamma,8))+ ".pp" 
