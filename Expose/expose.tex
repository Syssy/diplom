...
Zusätzlich zur Simulation können die mit dem Modell zu erwartenden Peaks berechnet werden. Dazu werden die genannten Annahmen als Probabilistischer Arithmetischer Automat (PAA) \cite{MHKR} modelliert. %Für diesen existiern Algorithmen, die eine Zustand-Werte-Verteilung nach einer gegebenen Anzahl von Schritten berechnen. In der dafür nötigen Modellierung entspricht ein Schritt dabei einem ortsschritt und die Werte den benötigten Zeitschritten. %todo{Ausformulieren PAA-Modellierung}
