...
\begin{itemize}
 ...
 \item Alternativ: Weitere Analyse durch zum Beispiel
 \begin{itemize}
  \item Massenspektrometrie (MS)
  \item Ionen-Mobilitäts-Spektrometrie (IMS)
 \end{itemize}
\end{itemize}
$\rightarrow$ Vorliegende Datensätze aus MCC-IMS-Kopplung
\end {frame}
...
\begin{frame}
\frametitle {Beobachtungen an den vorliegenden Daten(1)}
...
\begin{figure}
 \centering
 \includegraphics[width=0.9\textwidth]{BD15_1304101102_180_2}
\end{figure}
...
Prinzip:
\begin{itemize}
 \item 2 Phasen: stationär und mobil
 \item Wechsel dazwischen, bzw Verweilen in der Phase
\end{itemize}

Modell:
\begin{itemize}
 \item 2 Zustände: $s$ und $m$
 \item Wechselwahrscheinlichkeiten
 \begin{itemize}
...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=4cm,
  ...
  \node[main node] (m) [right of=s] {mob};
...
\begin{itemize}
 \item Länge festgelegt auf 200000 Einheiten 
 \begin{itemize}
...
$ \mathcal{P} = (\mathcal{Q}, q_0, T, \mathcal{V}, v_0, \mathcal{E}, (e_q)_{q\in\mathcal{Q}}, (\theta_q)_{q\in\mathcal{Q}})$
mit:
\begin{itemize}
...
\begin{itemize}
 \item Bisher keine Unterscheidung zwischen Adsorption und Lösung
 \item Weiterer stationärer Zustand
 \begin{itemize}
  \item Keine Übergänge zwischen den stationären Zuständen
  \item Nßeuer Zustand als Zwischenzustand
 \end{itemize}
 \item 
\end{itemize}
