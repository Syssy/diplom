...
\subtitle{Einführungsvortrag Diplomarbeit}
\author[E.Böhmer]{Elisabeth Böhmer}
\date{\today}
\institute [TuDO] {Technische Universität Dortmund\\}
...
\begin{itemize}
 \item Trennsäule in der Gaschromatographie
\end{itemize}
\pause
%(Kurz anreissen, später mehr)
``Simulation''
\begin{itemize}
 \item <+-> Keine physikalische Simulation der Moleküle
 \item <+-> Keine Interpolation vorhandender Messungen
 \item <+-> Sondern: Modell für chromatographischen Prozess
\end{itemize}
...
\begin{itemize}
 \item Detektion der aus Säule austretenden Substanzen
 ...
 \end{itemize}
\end{itemize}
\onslide<3->{$\rightarrow$ Vorliegende Datensätze aus MCC-IMS-Kopplung}
\end {frame}
...
\begin{enumerate}
 ...
 \item <+-> Wiederholung von 2-5 bis ausreichend angenähert
\end{enumerate}
...
\begin{figure}
 \centering
 \includegraphics[width=0.85\textwidth]{params_50}
\end{figure}
\end {frame}
